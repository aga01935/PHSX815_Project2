...
=======
                Npass += float(v)
>>>>>>> 7aeb6841db006c21d7b36f0e6ec3a40eb718a7e0
...
>>>>>>> 7aeb6841db006c21d7b36f0e6ec3a40eb718a7e0
    # make Npass figure
    plt.figure()
    plt.hist(Npass0, Ntoss-1, density=True, facecolor='b', alpha=0.5,range=(1,5), label="assuming $\\mathbb{H}_0$")
    if haveH1:
        plt.hist(Npass1, Ntoss-1, density=True, facecolor='g', alpha=0.5,range=(1,5), label="assuming $\\mathbb{H}_1$")
        plt.legend()
